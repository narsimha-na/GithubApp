...
import com.example.githubapp.model.Constants;
import com.example.githubapp.model.GitHubUser;
import com.example.githubapp.model.data.IGitHubService;
...
public class MainViewModel {
    ...
    public void discoverMoreGists() {
        mGitHubService.getPulicGists().enqueue(new Callback<List<Gist>>() {
            @Override
